...
public class SendMail {
	...
	/*创建邮件对象*/
	Message message=createSimpleMail(session,userEmail);
	/*发送邮件 并结束*/
	...
	/*继续编辑  邮件的 发送内容*/
	public static MimeMessage createSimpleMail(Session session,String userEmail) throws Exception{
		/*创建邮件对象*/
		...
		/*编辑邮件的标题*/
		message.setSubject("某某互娱电影资源网");
		/*邮件的文本内容  注意是可以在邮件中写H5对应标签的*/
		message.setContent("<h2  style='color:red;'>欢迎您注册某某互娱电影资源网，祝您休闲愉快</h2>大吉大利!!!", "text/html;charset=UTF-8");
	return message;
	}
